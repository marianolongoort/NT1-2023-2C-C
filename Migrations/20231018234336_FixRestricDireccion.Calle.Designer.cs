...
namespace Estacionamiento_C.Migrations
{
    ...
    [Migration("20231018234336_FixRestricDireccion.Calle")]
    partial class FixRestricDireccionCalle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estacionamiento_C.Models.Estancia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estacionamiento_C.Models.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estacionamiento_C.Models.Empleado", b =>
                {
                    b.HasBaseType("Estacionamiento_C.Models.Persona");
            ...
            modelBuilder.Entity("Estacionamiento_C.Models.Direccion", b =>
                {
                    b.HasOne("Estacionamiento_C.Models.Cliente", "Cliente")
                        .WithOne("Direccion")
                        .HasForeignKey("Estacionamiento_C.Models.Direccion", "ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Estacionamiento_C.Models.Pago", b =>
                {
                    b.HasOne("Estacionamiento_C.Models.Estancia", "Estancia")
                        .WithOne("Pago")
                        .HasForeignKey("Estacionamiento_C.Models.Pago", "EstanciaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
